# Generated by Django 2.0.3 on 2018-05-25 09:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accident', '0016_auto_20180525_1214'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='accident',
            name='status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='accident.Status', verbose_name='Статус'),
        ),
        migrations.AlterField(
            model_name='accident',
            name='system',
